...
export function getTrainLearningRate() {
  return Number.parseFloat(document.getElementById('train-learningrate').value);
}

export function getTrainBatchSize() {
  return Number.parseInt(document.getElementById('train-batchsize').value);
}
...
export function getModelDenseSize() {
  return Number.parseInt(document.getElementById('train-densesize').value);
}
